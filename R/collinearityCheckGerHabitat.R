...
#' available covariates. See that function's documentation for the full
#' rationale -- this guarantees the same base output columns
#' (AREA_NATIONAL_CODE, year, latin_name, occurrence, x, y, foldID)
#' regardless of the `runSpatialBlocking`/`runCollinearityCheck` toggles.
#'
